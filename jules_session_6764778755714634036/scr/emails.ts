...
export async function sendVerificationEmail(email: string, name: string, verificationCode: string) {
  ...
  const content = `
    <p>سلام ${name} عزیز،</p>
    <p>به SEOrchable خوش آمدید! کد تایید شما جهت فعال‌سازی حساب کاربری به شرح زیر است:</p>
    <h2 dir="ltr" style="text-align: center; color: #3b82f6; letter-spacing: 0.5em; font-size: 32px; background: #f3f4f6; padding: 16px; border-radius: 8px;">${verificationCode}</h2>
    <p>لطفاً این کد را در صفحه تایید ایمیل وارد نمایید.</p>
